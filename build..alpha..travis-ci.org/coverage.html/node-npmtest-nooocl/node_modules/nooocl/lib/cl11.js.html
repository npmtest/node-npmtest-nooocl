...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nooocl/node_modules/nooocl/lib/cl11.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nooocl/node_modules/nooocl/lib/cl11.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nooocl/node_modules/nooocl/lib/</a> &#187; cl11.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function CL11() {</span>
...
<span class="cstat-no" title="statement not covered" >    this.version = 1.1;</span>
<span class="cstat-no" title="statement not covered" >    this.libName = (process.platform === "win32") ? "OpenCL" : (process.platform === "darwin") ? "/System/Library/Frameworks/OpenCL.framework/OpenCL" : "libOpenCL.so";</span>
<span class="cstat-no" title="statement not covered" >    this.imports = new ffi.Library(this.libName,</span>
        {
            /* Platform APIs */
...
CL11.defs = defs;
&nbsp;
CL11.prototype.checkError = <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >        if (_.isFunction(err.deref)) {</span>
<span class="cstat-no" title="statement not covered" >            err = err.deref();</span>
        }
<span class="cstat-no" title="statement not covered" >        if (err &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            throw new CLError(err);</span>
        }
    }
};
&nbsp;
